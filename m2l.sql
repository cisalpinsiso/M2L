...
DROP TABLE IF EXISTS `annonce_global`;
...
CREATE TABLE `annonce_global` (
  ...
  CONSTRAINT `annonce_global_ibfk_1` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateur` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `annonce_global`
--

LOCK TABLES `annonce_global` WRITE;
/*!40000 ALTER TABLE `annonce_global` DISABLE KEYS */;
/*!40000 ALTER TABLE `annonce_global` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `match_rencontre`
--

DROP TABLE IF EXISTS `match_rencontre`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `match_rencontre`
--

LOCK TABLES `match_rencontre` WRITE;
/*!40000 ALTER TABLE `match_rencontre` DISABLE KEYS */;
/*!40000 ALTER TABLE `match_rencontre` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `message_equipe`
--

DROP TABLE IF EXISTS `message_equipe`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `message_equipe` (
  ...
  CONSTRAINT `message_equipe_ibfk_1` FOREIGN KEY (`id_equipe`) REFERENCES `equipe` (`id`),
  CONSTRAINT `message_equipe_ibfk_2` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateur` (`id`),
  CONSTRAINT `message_equipe_ibfk_3` FOREIGN KEY (`id_message`) REFERENCES `message` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `message_equipe`
--

LOCK TABLES `message_equipe` WRITE;
/*!40000 ALTER TABLE `message_equipe` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_equipe` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `message_prive` (
  ...
  `id_message` int(255) NOT NULL,
  KEY `id_message` (`id_message`),
  CONSTRAINT `message_prive_ibfk_1` FOREIGN KEY (`id_message`) REFERENCES `message` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `message_prive`
--

LOCK TABLES `message_prive` WRITE;
/*!40000 ALTER TABLE `message_prive` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_prive` ENABLE KEYS */;
UNLOCK TABLES;
...
(75,'Sarrazin','Nicolas','test@gmail.com','$2b$10$GOlxyaYp1jJHUyhY2lV2G.z5BflqDcdyxi5m.UQdkn2x49MgKqVAi','joueur',1),
(76,'Arthur','Laflaque','test2@gmail.com','$2b$10$NlyXt/G/bKXLsLoucpaR3eyL4Gdk1WVok7A2wpZeZWQpPnliNn..m','joueur',1),
(77,'Test2','Test2','test2@gmail.com','$2b$10$APFs0nXwr9XTH3A/NQw1Fe76i/TqOjk106rGceU8BcoDonfbVNNE.','joueur',NULL);
...
-- Dump completed on 2024-03-15 14:44:30
